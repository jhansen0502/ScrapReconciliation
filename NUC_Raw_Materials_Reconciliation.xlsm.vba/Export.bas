Sub ExportToNew()
    ...
    Sheets(Array("Home", "Reconciled Receipts", "Oracle Report", "ScrapConnect Report", "Receipts Missing From Oracle", _
    "Receipts Missing From SC", "Void and RTV", "Weight Discrepancies")).Copy
    On Error GoTo 0
